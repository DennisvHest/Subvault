namespace Subvault_Domain.Migrations {
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Subvault_Domain.Concrete.EFDbContext> {
        ...
        protected override void Seed(Subvault_Domain.Concrete.EFDbContext context) {
            ...
            //Person person1 = new CrewMember { Id = 366, Name = "James Mangold" };
            ...
            ////ItemCastMembers
            //context.ItemCastMembers.RemoveRange(context.ItemCastMembers);

            //ItemCastMember itemCastMember1 = new ItemCastMember { Item = movie1, CastMember = (CastMember)person2, Character = "Logan / X-24" };
            //ItemCastMember itemCastMember2 = new ItemCastMember { Item = movie1, CastMember = (CastMember)person3, Character = "Charles" };
            //ItemCastMember itemCastMember3 = new ItemCastMember { Item = movie1, CastMember = (CastMember)person4, Character = "Laura" };
            //ItemCastMember itemCastMember4 = new ItemCastMember { Item = movie1, CastMember = (CastMember)person5, Character = "Pierce" };
            //ItemCastMember itemCastMember5 = new ItemCastMember { Item = movie1, CastMember = (CastMember)person5, Character = "Caliban" };

            //context.ItemCastMembers.AddOrUpdate(itemCastMember1);
            //context.ItemCastMembers.AddOrUpdate(itemCastMember2);
            //context.ItemCastMembers.AddOrUpdate(itemCastMember3);
            //context.ItemCastMembers.AddOrUpdate(itemCastMember4);
            //context.ItemCastMembers.AddOrUpdate(itemCastMember5);

            ////ItemCrewMembers
            //context.ItemCrewMembers.RemoveRange(context.ItemCrewMembers);

            //ItemCrewMember itemCrewMember1 = new ItemCrewMember { Item = movie1, CrewMember = (CrewMember)person1, Job = "Director" };

            //context.ItemCrewMembers.AddOrUpdate(itemCrewMember1);
